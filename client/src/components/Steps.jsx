...
export default function Steps() {
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semi-bold bg-gradient-to-r from-gray-900 to gray-400 bg-clip-text text-transparent'>Steps to remove background <br /> images in seconds</h1>
